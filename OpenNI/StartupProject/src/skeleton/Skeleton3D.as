package skeleton
{
	...
	public class Skeleton3D extends Pivot3D
	{
		...
		public function getPoint3DJoint($joint:com.motionnexus.openni.data.skeleton.MotionNexusSkeletonJoint):Vector3D
		{
		...
		public function updateSkeleton():void
		{
			...
			addLine(spine, leftHip, leftKnee, leftAnkle3D.getPosition());
			addLine(spine, rightHip, rightKnee, rightAnkle3D.getPosition());
		}
