package skeleton
{
	...
	import com.motionnexus.openni.infastructure.IMotionNexusListenerSkeleton;
	...
	public class SkeletonWorld extends UIComponent implements IMotionNexusListenerSkeleton
	{
		...
		public function addSkeleton($skeleton:MotionNexusSkeleton):void
		{
			...
			{
				_currentSkeleton3D=new Skeleton3D();
		...
		{
			var VCenter:Number=_currentSkeleton3D.leftAnkle3D.y - _currentSkeleton3D.head3D.y;
